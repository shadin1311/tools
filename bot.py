...
# --- আপনার অনলাইন ইউজার লিস্টের লিঙ্ক (Raw Link হতে হবে) ---
# এখানে আপনার GitHub Gist বা Pastebin এর Raw লিঙ্কটি বসান
...
# --- লাইসেন্স এবং HWID চেক সিস্টেম ---
def get_hwid():
    try:
        # এটি আরও উন্নত পদ্ধতি যা wmic ছাড়াও কাজ করবে
...
async def start_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text("বট চালু হয়েছে। আপনার Usernames গুলো দিন:", reply_markup=get_keyboard())
...
async def receive_usernames(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(f"{len(context.user_data['list_usernames'])}টি আইডি পাওয়া গেছে। পাসওয়ার্ড দিন:")
    return GET_PASSWORD
...
async def receive_password(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text("2FA Keys দিন (সিরিয়াল অনুযায়ী):")
    return GET_2FA_KEYS
...
async def process_all_accounts(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text("লগইন প্রসেস শুরু হয়েছে... দয়া করে অপেক্ষা করুন।")
    results = []
...
async def cancel(update: Update, context: ContextTypes.DEFAULT_TYPE):
    context.user_data.clear()
    await update.message.reply_text("অপারেশন বন্ধ হয়েছে।", reply_markup=get_keyboard())
...
def main():
    ...
    try:
        ...
        input("পুনরায় চেষ্টা করতে এন্টার চাপুন...")
